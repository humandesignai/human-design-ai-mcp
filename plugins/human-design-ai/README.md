...
Universal ChatGPT/Codex and Claude Code package for the official HumanDesign.ai MCP, backed by the same validated, versioned calculation service that powers HumanDesign.ai and including primary-chart resolution, saved composite access, and deterministic bodygraph rendering.
